...
问题一：如果是在最后一个位置进行入队，那么元素应该需要添加到环的第一个元素。

<img src="https://cdn.jsdelivr.net/gh/wicksonZhang/static-source-cdn/images/202311231759622.png" alt="image-20231123175925570" style="zoom:80%;float:left" />
