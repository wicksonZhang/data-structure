...
<img src="https://cdn.jsdelivr.net/gh/wicksonZhang/static-source-cdn/images/202312112138554.png" alt="image-20231211213850454" style="zoom:60%;float:left" />
...
```java
    ...
    public Node<E> predecessor(Node<E> node) {
        ...
        // 以节点 9 为例，最后 node = 13，所以最后只能是 node.parentNode
